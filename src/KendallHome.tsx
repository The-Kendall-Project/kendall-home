...
const CSS = `
.kh-bar{display:flex;align-items:center;gap:2px;width:100%;height:44px;min-height:44px;padding:0 12px;border:0;border-bottom:1px solid #1D477B;background:#24528C;color:#FFFFFF;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;}
...
.kh-bar .kh-tabs{display:flex;flex:1;align-items:stretch;justify-content:flex-start;gap:2px;width:auto;height:44px;min-width:0;margin:0;padding:0;border:0;background:transparent;overflow-x:auto;}
